              ...
              <div className="space-y-4 text-right">
                ...
                <div>
                  ...
                  <ul className="list-disc pr-5 space-y-1">
                    ...
                    <li>تبسيط التعليم وتعلم اللغات (حالياً أتعلم الألمانية بالدارجة الجزائرية)</li>
                  </ul>
                </div>
                <div>
                ...
                <p>
                  خارج نطاق العمل، أحب القراءة في مجالات الذكاء الاصطناعي والتطوير الذاتي، وممارسة رياضة الجري وركوب الدراجات.
                </p>
              </div>
            </CardContent>
          </Card>
